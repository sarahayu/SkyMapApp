...
{
  uint8_t buffer[6];
  I2Cdev::readBytes(HMC5883L_Address, DataRegisterBegin, 6, buffer);
...
{
    I2Cdev::writeBytes(HMC5883L_Address, address, 1, &data);
}

//uint8_t* HMC5883L::Read(int address, int length)
//{
//    I2Cdev::readBytes(HMC5883L_Address, address, length, uint8_t *data);
